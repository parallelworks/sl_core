...
# Replace the final_estimator with default Scikit-Learn
# LinearRegression with non-negative least squares.
# https://scikit-learn.org/stable/auto_examples/linear_model/plot_nnls.html
# NOTE: The non-negative option requires Scikit-Learn >= v0.24
# which is one version past the version of Scikit-Learn
# we have been pinned for the SuperLearner due to Dask
# compatibility.
SuperLearnerConf = {
